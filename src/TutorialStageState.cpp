...
TutorialStageState::TutorialStageState() : State() {
	...
	monsterList.emplace_back(Personality("suit", 150, 150, 5, 0.3, 5, 1, { "girl" }, {"trashcan"}));
